...
\para{Manual polices are sub-optimal.} While existing work such as
...
Analytical applications have their own goals, entailing different optimization metrics. 
%
...
%
For instance, each video algorithm relies on different features from the data. For example, computer
vision detection algorithms depend on the edge
...
Also, similar applications face different data distributions. Compare the stationary
