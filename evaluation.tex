...
%% Latency to sink: 65.2, 22.2, 50.3
...
\begin{figure}
  ...
  \begin{subfigure}[t]{\columnwidth}
    \includegraphics[width=\columnwidth]{figures/runtime_darknet-cdf.pdf}
    \caption{CDF of \sysname{} runtime evaluation.}
  ...
  \begin{subfigure}[t]{\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{figures/runtime_darknet-bar.pdf}
    \caption{Bar plot for sysname{} runtime evaluation.}
