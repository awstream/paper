...
behaviors. \autoref{fig:runtime-bar} shows a summary of all three applications.
...
\begin{figure}
  \centering
  \includegraphics[width=0.95\columnwidth]{figures/runtime-bar.pdf}
  \caption{\sysname{} in comparison with JetStream++.}
  \label{fig:runtime-bar}
\end{figure}
