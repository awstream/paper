...
behaviors. \autoref{fig:darknet-runtime-boxplot} shows a summary of all three
applications.
...
\begin{figure}
  ...
  \caption{Box plot for \sysname{} runtime evaluation.}
  \label{fig:darknet-runtime}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{figures/runtime_darknet-bench.pdf}
