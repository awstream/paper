...
low latency and high accuracy simultaneously. We present the results in a
...
caused by slow congestion detection when the RTT is high. In terms of accuracy,
\sysname{} achieves similarly high accuracy.
