...
\para{Large bandwidth variation.} For all three applications, there is three to
...
\para{Multiple dimensions achieve the optimal.} Compare the dotted lines in each
