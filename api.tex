...
\sysname{} integrates new \maybe{} operators that degrades the data quality,
yielding potential bandwidth savings. Our API design has three considerations:
...
should be modular: each operator is a unit and developer can chain multiple
...
optionally takes the top values of a \textit{list}; and
