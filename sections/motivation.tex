...
\para{Manual polices are sub-optimal.} JetStream~\cite{rabkin2014aggregation}
pioneered the use of degradation to address bandwidth limits in wide area. While
