...
WAN bandwidth is insufficient and costly~\cite{hsieh17gaia, pu2015low,
  vulimiri2015wananlytics, vulimiri2015global}. Using Amazon EC2 as a case
study, the WAN bandwidth capacity is 15x smaller than their LAN bandwidth on
average, and up to 60x smaller in the worst case~\cite{hsieh17gaia}. In terms of
pricing, the average WAN bandwidth cost is up to 38x of the cost of renting two
...
\para{Application-specific optimizations do not generalize.} Because
...
%% LocalWords: bw runtime QoE analytics
