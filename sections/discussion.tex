...
\paraf{Reducing Developer Effort.} While \sysname{} focuses on reducing
developer effort from tedious manual policy construction, there are still
...
\para{Profile Modeling.} \sysname{} currently does not model $B(c)$ or
...
%% LocalWords: CherryPick runtime MPC QoE