...
The two accuracy figures show that other than UDP, most schemes are able to
...
\footnotetext{TK's baselines are only streaming over TCP/UDP because HLS and
  JetStream are not directly comparable (see appendix).}

\para{Runtime performance of PD and TK (\autoref{fig:pd-tk})}. For PD,
